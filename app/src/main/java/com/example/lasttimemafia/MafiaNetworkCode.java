...
public class MafiaNetworkCode extends AppCompatActivity {
    ...
    public void sendMessage(String message) {
        Log.d("precisesend","sendMessage");
        if (SettingsMenu.getDefaults("wan", "false").equals("true")) {
            sendMessageFirebase("message", message, hostGame.gameCode);
        } else if (SettingsMenu.getDefaults("wan", "false").equals("false")) {
            out.println(message);
        }
    }
    ...
    public String receiveMessage(Socket socket) throws IOException, InterruptedException {
        ...
        Log.d("samebois","Value of received message:" + receivedMessage);
        ...
        public class RegisterNameReceiver extends BroadcastReceiver {
            ...
            public void onReceive(Context context, Intent intent) {
                Log.d("gamernation", "In RegisterNameReceiver!");
        ...
        public void checkToRegister (String name, String port) throws
        InterruptedException, IOException {
            Log.d("gamernation", "In CheckToregister");
            if (portNumber == Integer.parseInt(port)) {
                ...
                context.registerReceiver(_updateName, filter);
                Log.d("kingpluto","pre do thing confirmed!");
                doThingAfterNameConfirmed();
        ...
        public void doThingAfterNameConfirmed () throws IOException, InterruptedException {
            Log.d("gamernation", "In doThingAfterNameConfirmed");
            hostGame.currentNumOfPlayers++;
            currentNumOfPlayers++;
            //sendMessage("totalplayers " + totalNumOfPlayers);
        ...
        public void sendMessageFirebase (String purpose, String message, String gameCode){
            Map<String, Object> data = new HashMap<>();
            data.put("message", message);
            data.put("purpose", purpose);
            data.put("gameCode", gameCode);
            data.put("name", playerName);
            Log.d("gamernation","sendMessage function called from host");
    ...
    public void onDestroy() {
        super.onDestroy();
        this.unregisterReceiver(this._updateName);
        this.unregisterReceiver(this._getUpdates);
    }
    }